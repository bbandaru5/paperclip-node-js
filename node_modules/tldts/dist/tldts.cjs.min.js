...
function a(c,e){var d=0,f=c.length,k=!1;if(!1===e){for(;d<c.length&&32>=c.charCodeAt(d);)d+=1;for(;f>d+1&&32>=c.charCodeAt(f-1);)--f;if(47===c.charCodeAt(d)&&47===c.charCodeAt(d+1))d+=2;else if(e=c.indexOf(":/",d),-1!==e){var g=e-d,p=c.charCodeAt(d),m=c.charCodeAt(d+1),t=c.charCodeAt(d+2),K=c.charCodeAt(d+3),ca=c.charCodeAt(d+4);if(5!==g||104!==p||116!==m||116!==t||112!==K||115!==ca)if(4!==g||104!==p||116!==m||116!==t||112!==K)if(3!==g||119!==p||115!==m||115!==t)if(2!==g||119!==p||115!==
m)for(g=d;g<e;g+=1)if(d=c.charCodeAt(g)|32,!1===(97<=d&&122>=d||48<=d&&57>=d||46===d||45===d||43===d))return null;for(d=e+2;47===c.charCodeAt(d);)d+=1;}m=p=e=-1;for(g=d;g<f;g+=1)if(t=c.charCodeAt(g),35===t||47===t||63===t){f=g;break}else 64===t?e=g:93===t?p=g:58===t?m=g:65<=t&&90>=t&&(k=!0);-1!==e&&e>d&&e<f&&(d=e+1);if(91===c.charCodeAt(d))return -1!==p?c.slice(d+1,p).toLowerCase():null;-1!==m&&m>d&&m<f&&(f=m);}for(;f>d+1&&46===c.charCodeAt(f-1);)--f;c=0!==d||f!==c.length?c.slice(d,f):c;return k?c.toLowerCase():
c}function b(c){return 97<=c&&122>=c||48<=c&&57>=c||127<c}function h(c){if(255<c.length||0===c.length||!b(c.charCodeAt(0)))return !1;for(var e=-1,d=-1,f=c.length,k=0;k<f;k+=1){var g=c.charCodeAt(k);if(46===g){if(64<k-e||46===d||45===d||95===d)return !1;e=k;}else if(!b(g)&&45!==g&&95!==g)return !1;d=g;}return 63>=f-e-1&&45!==d}
function l(c){var e=c.allowIcannDomains,d=c.allowPrivateDomains,f=c.detectIp,k=c.extractHostname,g=c.mixedInputs,p=c.validHosts;c=c.validateHostname;return {allowIcannDomains:void 0===e?!0:e,allowPrivateDomains:void 0===d?!1:d,detectIp:void 0===f?!0:f,extractHostname:void 0===k?!0:k,mixedInputs:void 0===g?!0:g,validHosts:void 0===p?null:p,validateHostname:void 0===c?!0:c}}var aa=l({});
function n(c,e,d,f){var k=void 0===f?aa:l(f);f={domain:null,hostname:null,isIcann:null,isIp:null,isPrivate:null,publicSuffix:null,subdomain:null};if("string"!==typeof c)return f;f.hostname=!1===k.extractHostname?c:!0===k.mixedInputs?a(c,h(c)):a(c,!1);if(0===e||null===f.hostname)return f;if(!0===k.detectIp){c=f.hostname;a:if(39<c.length)var g=!1;else{g=!1;for(var p=0;p<c.length;p+=1){var m=c.charCodeAt(p);if(58===m)g=!0;else if(!1===(48<=m&&57>=m||97<=m&&102>=m)){g=!1;break a}}}if(!g)a:if(7>c.length||
15<c.length)g=!1;else{for(p=g=0;p<c.length;p+=1)if(m=c.charCodeAt(p),46===m)g+=1;else if(48>m||57<m){g=!1;break a}g=3===g&&46!==c.charCodeAt(0)&&46!==c.charCodeAt(c.length-1);}f.isIp=g;if(!0===f.isIp)return f}if(!0===k.validateHostname&&!0===k.extractHostname&&!1===h(f.hostname))return f.hostname=null,f;d(f.hostname,k,f);if(2===e||null===f.publicSuffix)return f;a:{c=f.publicSuffix;d=f.hostname;if(null!==k.validHosts)for(k=k.validHosts,g=0;g<k.length;g+=1){p=k[g];m=d;var t=p;if(m.endsWith(t)&&(m.length===
t.length||"."===m[m.length-t.length-1])){k=p;break a}}c.length===d.length?k=null:(k=d.lastIndexOf(".",d.length-c.length-2),k=-1===k?d:d.slice(k+1));}f.domain=k;if(3===e||null===f.domain)return f;e=f.hostname;k=f.domain;e=k.length===e.length?"":e.slice(0,-k.length-1);f.subdomain=e;return f}var q,r={$:1,succ:{}},u={$:0,succ:{city:r}};q={$:0,succ:{ck:{$:0,succ:{www:r}},jp:{$:0,succ:{kawasaki:u,kitakyushu:u,kobe:u,nagoya:u,sapporo:u,sendai:u,yokohama:u}}}};
var v,w={$:1,succ:{}},x={$:1,succ:{com:w,edu:w,gov:w,net:w,mil:w,org:w}},y={$:2,succ:{}},z={$:1,succ:{blogspot:y}},A={$:1,succ:{gov:w}},B={$:0,succ:{"*":y}},C={$:0,succ:{"*":w}},D={$:1,succ:{com:w,edu:w,net:w,org:w,gov:w}},E={$:1,succ:{co:y}},F={$:1,succ:{ng:y}},G={$:0,succ:{s3:y}},H={$:0,succ:{dualstack:G}},I={$:0,succ:{s3:y,dualstack:G,"s3-website":y}},J={$:0,succ:{apps:y}},L={$:0,succ:{app:y}},M={$:1,succ:{com:w,edu:w,net:w,org:w}},N={$:1,succ:{ybo:y}},O={$:1,succ:{nom:y}},P={$:1,succ:{gov:w,blogspot:y,
nym:y}},Q={$:0,succ:{cust:y}},R={$:1,succ:{edu:w,biz:w,net:w,org:w,gov:w,info:w,com:w}},S={$:1,succ:{blogspot:y,nym:y}},T={$:1,succ:{"for":y}},U={$:1,succ:{barsy:y}},V={$:0,succ:{forgot:y}},W={$:1,succ:{gs:w}},ba={$:0,succ:{nes:w}},X={$:1,succ:{k12:w,cc:w,lib:w}},Y={$:1,succ:{cc:w,lib:w}};
v={$:0,succ:{ac:x,ad:{$:1,succ:{nom:w}},ae:{$:1,succ:{co:w,net:w,org:w,sch:w,ac:w,gov:w,mil:w,blogspot:y,nom:y}},aero:{$:1,succ:{"accident-investigation":w,"accident-prevention":w,aerobatic:w,aeroclub:w,aerodrome:w,agents:w,aircraft:w,airline:w,airport:w,"air-surveillance":w,airtraffic:w,"air-traffic-control":w,ambulance:w,amusement:w,association:w,author:w,ballooning:w,broker:w,caa:w,cargo:w,catering:w,certification:w,championship:w,charter:w,civilaviation:w,club:w,conference:w,consultant:w,consulting:w,
...
safety:w,scientist:w,services:w,show:w,skydiving:w,software:w,student:w,trader:w,trading:w,trainer:w,union:w,workinggroup:w,works:w}},af:{$:1,succ:{gov:w,com:w,org:w,net:w,edu:w,nom:y}},ag:{$:1,succ:{com:w,org:w,net:w,co:w,nom:w}},ai:{$:1,succ:{off:w,com:w,net:w,org:w,uwu:y,nom:y}},al:{$:1,succ:{com:w,edu:w,gov:w,mil:w,net:w,org:w,blogspot:y,nom:y}},am:{$:1,succ:{co:w,com:w,commune:w,net:w,org:w,blogspot:y}},ao:{$:1,succ:{ed:w,gv:w,og:w,co:w,pb:w,it:w}},aq:w,ar:{$:1,succ:{com:z,edu:w,gob:w,gov:w,
"int":w,mil:w,musica:w,net:w,org:w,tur:w}},arpa:{$:1,succ:{e164:w,"in-addr":w,ip6:w,iris:w,uri:w,urn:w}},as:A,asia:{$:1,succ:{cloudns:y}},at:{$:1,succ:{ac:w,co:z,gv:w,or:w,futurecms:{$:0,succ:{"*":y,ex:B,"in":B}},futurehosting:y,futuremailing:y,ortsinfo:{$:0,succ:{ex:B,kunden:B}},biz:y,info:y,priv:y,"12hp":y,"2ix":y,"4lima":y,"lima-city":y}},au:{$:1,succ:{com:z,net:w,org:w,edu:{$:1,succ:{act:w,nsw:w,nt:w,qld:w,sa:w,tas:w,vic:w,wa:w}},gov:{$:1,succ:{qld:w,sa:w,tas:w,vic:w,wa:w}},asn:w,id:w,info:w,
...
zlg:w}},bs:{$:1,succ:{com:w,net:w,org:w,edu:w,gov:w,we:y}},bt:D,bv:w,bw:{$:1,succ:{co:w,org:w}},by:{$:1,succ:{gov:w,mil:w,com:z,of:w,nym:y}},bz:{$:1,succ:{com:w,net:w,org:w,edu:w,gov:w,za:y,nym:y}},ca:{$:1,succ:{ab:w,bc:w,mb:w,nb:w,nf:w,nl:w,ns:w,nt:w,nu:w,on:w,pe:w,qc:w,sk:w,yk:w,gc:w,barsy:y,awdev:B,co:y,blogspot:y,"no-ip":y}},cat:w,cc:{$:1,succ:{cloudns:y,ftpaccess:y,"game-server":y,myphotos:y,scrapping:y,twmail:y,fantasyleague:y}},cd:A,cf:z,cg:w,ch:{$:1,succ:{square7:y,blogspot:y,"linkyard-cloud":y,
...
"xn--io0a7i":w,"\u7f51\u7edc":w,"xn--od0alg":w,"\u7db2\u7d61":w,ah:w,bj:w,cq:w,fj:w,gd:w,gs:w,gz:w,gx:w,ha:w,hb:w,he:w,hi:w,hl:w,hn:w,jl:w,js:w,jx:w,ln:w,nm:w,nx:w,qh:w,sc:w,sd:w,sh:w,sn:w,sx:w,tj:w,xj:w,xz:w,yn:w,zj:w,hk:w,mo:w,tw:w,instantcloud:y}},co:{$:1,succ:{arts:w,com:z,edu:w,firm:w,gov:w,info:w,"int":w,mil:w,net:w,nom:w,org:w,rec:w,web:w,"go-vip":y,carrd:y,crd:y,otap:B,leadpages:y,lpages:y,mypi:y,n4t:y,nodum:y,repl:y}},com:{$:1,succ:{amazonaws:{$:0,succ:{compute:B,"compute-1":B,"us-east-1":{$:2,
...
org:w,edu:w,gov:w,gob:w,mil:w}},edu:{$:1,succ:{rit:{$:0,succ:{"git-pages":y}}}},ee:{$:1,succ:{edu:w,gov:w,riik:w,lib:w,med:w,com:z,pri:w,aip:w,org:w,fie:w}},eg:{$:1,succ:{com:z,edu:w,eun:w,gov:w,mil:w,name:w,net:w,org:w,sci:w}},er:C,es:{$:1,succ:{com:z,nom:w,org:w,gob:w,edu:w}},et:{$:1,succ:{com:w,gov:w,org:w,edu:w,biz:w,name:w,info:w,net:w}},eu:{$:1,succ:{mycd:y,cloudns:y,barsy:y,wellbeingzone:y,spdns:y,transurl:B,diskstation:y}},fi:{$:1,succ:{aland:w,dy:y,blogspot:y,"xn--hkkinen-5wa":y,"h\u00e4kkinen":y,
...
"\u798f\u4e95":w,"xn--4it168d":w,"\u798f\u5ca1":w,"xn--klt787d":w,"\u798f\u5cf6":w,"xn--rny31h":w,"\u79cb\u7530":w,"xn--7t0a264c":w,"\u7fa4\u99ac":w,"xn--5rtq34k":w,"\u9999\u5ddd":w,"xn--k7yn95e":w,"\u9ad8\u77e5":w,"xn--tor131o":w,"\u9ce5\u53d6":w,"xn--d5qv7z876c":w,"\u9e7f\u5150\u5cf6":w,kawasaki:C,kitakyushu:C,kobe:C,nagoya:C,sapporo:C,sendai:C,yokohama:C,usercontent:y,blogspot:y}},ke:{$:1,succ:{ac:w,co:z,go:w,info:w,me:w,mobi:w,ne:w,or:w,sc:w,nom:y}},kg:x,kh:C,ki:R,km:{$:1,succ:{org:w,nom:w,gov:w,
...
pokrovsk:y,sochi:y,spb:y,tashkent:y,termez:y,togliatti:y,troitsk:y,tselinograd:y,tula:y,tuva:y,vladikavkaz:y,vladimir:y,vologda:y,nym:y}},sv:{$:1,succ:{com:w,edu:w,gob:w,org:w,red:w}},sx:{$:1,succ:{gov:w,nym:y}},sy:x,sz:{$:1,succ:{co:w,ac:w,org:w}},tc:w,td:z,tel:w,tf:w,tg:w,th:{$:1,succ:{ac:w,co:w,go:w,"in":w,mi:w,net:w,or:w,online:y,shop:y}},tj:{$:1,succ:{ac:w,biz:w,co:w,com:w,edu:w,go:w,gov:w,"int":w,mil:w,name:w,net:w,nic:w,org:w,test:w,web:w,nom:y}},tk:w,tl:A,tm:{$:1,succ:{com:w,co:w,org:w,net:w,
nom:w,gov:w,mil:w,edu:w}},tn:{$:1,succ:{com:w,ens:w,fin:w,gov:w,ind:w,intl:w,nat:w,net:w,org:w,info:w,perso:w,tourism:w,edunet:w,rnrt:w,rns:w,rnu:w,mincom:w,agrinet:w,defense:w,turen:w}},to:{$:1,succ:{com:w,gov:w,net:w,org:w,edu:w,mil:w,vpnplus:y}},tr:{$:1,succ:{av:w,bbs:w,bel:w,biz:w,com:z,dr:w,edu:w,gen:w,gov:w,info:w,mil:w,k12:w,kep:w,name:w,net:w,org:w,pol:w,tel:w,tsk:w,tv:w,web:w,nc:A}},tt:{$:1,succ:{co:w,com:w,org:w,net:w,biz:w,info:w,pro:w,"int":w,coop:w,jobs:w,mobi:w,travel:w,museum:w,aero:w,
...
freeddns:y,golffan:y,noip:y,pointto:y}},uy:{$:1,succ:{com:z,edu:w,gub:w,mil:w,net:w,org:w,nom:y}},uz:{$:1,succ:{co:w,com:w,net:w,org:w}},va:w,vc:{$:1,succ:{com:w,net:w,org:w,gov:w,mil:w,edu:w,nom:y}},ve:{$:1,succ:{arts:w,co:w,com:w,e12:w,edu:w,firm:w,gob:w,gov:w,info:w,"int":w,mil:w,net:w,org:w,rec:w,store:w,tec:w,web:w}},vg:O,vi:{$:1,succ:{co:w,com:w,k12:w,net:w,org:w}},vn:{$:1,succ:{com:w,net:w,org:w,edu:w,gov:w,"int":w,ac:w,biz:w,info:w,name:w,pro:w,health:w,blogspot:y}},vu:M,wf:w,ws:{$:1,succ:{com:w,
...
"\u0e23\u0e31\u0e10\u0e1a\u0e32\u0e25":w,"\u0e17\u0e2b\u0e32\u0e23":w,"\u0e40\u0e19\u0e47\u0e15":w,"\u0e2d\u0e07\u0e04\u0e4c\u0e01\u0e23":w}},"xn--pgbs0dh":w,"\u062a\u0648\u0646\u0633":w,"xn--kpry57d":w,"\u53f0\u7063":w,"xn--kprw13d":w,"\u53f0\u6e7e":w,"xn--nnx388a":w,"\u81fa\u7063":w,"xn--j1amh":w,"\u0443\u043a\u0440":w,"xn--mgb2ddes":w,"\u0627\u0644\u064a\u0645\u0646":w,xxx:w,ye:C,za:{$:0,succ:{ac:w,agric:w,alt:w,co:z,edu:w,gov:w,grondar:w,law:w,mil:w,net:w,ngo:w,nis:w,nom:w,org:w,school:w,tm:w,
...
alstom:w,americanexpress:w,americanfamily:w,amex:w,amfam:w,amica:w,amsterdam:w,analytics:w,android:w,anquan:w,anz:w,aol:w,apartments:w,app:{$:1,succ:{wnext:y,run:{$:2,succ:{a:y}},web:y,hasura:y,loginline:y,telebit:y}},apple:w,aquarelle:w,arab:w,aramco:w,archi:w,army:w,art:w,arte:w,asda:w,associates:w,athleta:w,attorney:w,auction:w,audi:w,audible:w,audio:w,auspost:w,author:w,auto:w,autos:w,avianca:w,aws:w,axa:w,azure:w,baby:w,baidu:w,banamex:w,bananarepublic:w,band:w,bank:w,bar:w,barcelona:w,barclaycard:w,
...
rodeo:w,rogers:w,room:w,rsvp:w,rugby:w,ruhr:w,run:{$:1,succ:{development:y,ravendb:y,repl:y}},rwe:w,ryukyu:w,saarland:w,safe:w,safety:w,sakura:w,sale:T,salon:w,samsclub:w,samsung:w,sandvik:w,sandvikcoromant:w,sanofi:w,sap:w,sarl:w,sas:w,save:w,saxo:w,sbi:w,sbs:w,sca:w,scb:w,schaeffler:w,schmidt:w,scholarships:w,school:w,schule:w,schwarz:w,science:N,scjohnson:w,scor:w,scot:w,search:w,seat:w,secure:w,security:w,seek:w,select:w,sener:w,services:{$:1,succ:{loginline:y}},ses:w,seven:w,sew:w,sex:w,sexy:w,
sfr:w,shangrila:w,sharp:w,shaw:w,shell:w,shia:w,shiksha:w,shoes:w,shop:U,shopping:w,shouji:w,show:w,showtime:w,shriram:w,silk:w,sina:w,singles:w,site:{$:1,succ:{cloudera:y,cyon:y,loginline:y,barsy:y,platformsh:B,byen:y}},ski:w,skin:w,sky:w,skype:w,sling:w,smart:w,smile:w,sncf:w,soccer:w,social:w,softbank:w,software:w,sohu:w,solar:w,solutions:w,song:w,sony:w,soy:w,space:{$:1,succ:{linkitools:y,uber:y,xs4all:y}},sport:w,spot:w,spreadbetting:w,srl:w,srt:w,stada:w,staples:w,star:w,starhub:w,statebank:w,
statefarm:w,stc:w,stcgroup:w,stockholm:w,storage:w,store:w,stream:w,studio:w,study:w,style:w,sucks:w,supplies:w,supply:w,support:U,surf:w,surgery:w,suzuki:w,swatch:w,swiftcover:w,swiss:w,sydney:w,symantec:w,systems:{$:1,succ:{knightpoint:y}},tab:w,taipei:w,talk:w,taobao:w,target:w,tatamotors:w,tatar:w,tattoo:w,tax:w,taxi:w,tci:w,tdk:w,team:w,tech:w,technology:E,telefonica:w,temasek:w,tennis:w,teva:w,thd:w,theater:w,theatre:w,tiaa:w,tickets:w,tienda:w,tiffany:w,tips:w,tires:w,tirol:w,tjmaxx:w,tjx:w,
tkmaxx:w,tmall:w,today:w,tokyo:w,tools:w,top:{$:1,succ:{"now-dns":y,ntdll:y}},toray:w,toshiba:w,total:w,tours:w,town:w,toyota:w,toys:w,trade:N,trading:w,training:w,travel:w,travelchannel:w,travelers:w,travelersinsurance:w,trust:w,trv:w,tube:w,tui:w,tunes:w,tushu:w,tvs:w,ubank:w,ubs:w,uconnect:w,unicom:w,university:w,uno:w,uol:w,ups:w,vacations:w,vana:w,vanguard:w,vegas:w,ventures:w,verisign:w,versicherung:w,vet:w,viajes:w,video:w,vig:w,viking:w,villas:w,vin:w,vip:w,virgin:w,visa:w,vision:w,vistaprint:w,
viva:w,vivo:w,vlaanderen:w,vodka:w,volkswagen:w,volvo:w,vote:w,voting:w,voto:w,voyage:w,vuelos:w,wales:w,walmart:w,walter:w,wang:w,wanggou:w,warman:w,watch:w,watches:w,weather:w,weatherchannel:w,webcam:w,weber:w,website:w,wed:w,wedding:w,weibo:w,weir:w,whoswho:w,wien:w,wiki:w,williamhill:w,win:w,windows:w,wine:w,winners:w,wme:w,wolterskluwer:w,woodside:w,work:{$:1,succ:{of:y,to:y}},works:w,world:w,wow:w,wtc:w,wtf:w,xbox:w,xerox:w,xfinity:w,xihuan:w,xin:w,"xn--11b4c3d":w,"\u0915\u0949\u092e":w,"xn--1ck2e1b":w,
"\u30bb\u30fc\u30eb":w,"xn--1qqw23a":w,"\u4f5b\u5c71":w,"xn--30rr7y":w,"\u6148\u5584":w,"xn--3bst00m":w,"\u96c6\u56e2":w,"xn--3ds443g":w,"\u5728\u7ebf":w,"xn--3oq18vl8pn36a":w,"\u5927\u4f17\u6c7d\u8f66":w,"xn--3pxu8k":w,"\u70b9\u770b":w,"xn--42c2d9a":w,"\u0e04\u0e2d\u0e21":w,"xn--45q11c":w,"\u516b\u5366":w,"xn--4gbrim":w,"\u0645\u0648\u0642\u0639":w,"xn--55qw42g":w,"\u516c\u76ca":w,"xn--55qx5d":w,"\u516c\u53f8":w,"xn--5su34j936bgsg":w,"\u9999\u683c\u91cc\u62c9":w,"xn--5tzm5g":w,"\u7f51\u7ad9":w,"xn--6frz82g":w,
"\u79fb\u52a8":w,"xn--6qq986b3xl":w,"\u6211\u7231\u4f60":w,"xn--80adxhks":w,"\u043c\u043e\u0441\u043a\u0432\u0430":w,"xn--80aqecdr1a":w,"\u043a\u0430\u0442\u043e\u043b\u0438\u043a":w,"xn--80asehdb":w,"\u043e\u043d\u043b\u0430\u0439\u043d":w,"xn--80aswg":w,"\u0441\u0430\u0439\u0442":w,"xn--8y0a063a":w,"\u8054\u901a":w,"xn--9dbq2a":w,"\u05e7\u05d5\u05dd":w,"xn--9et52u":w,"\u65f6\u5c1a":w,"xn--9krt00a":w,"\u5fae\u535a":w,"xn--b4w605ferd":w,"\u6de1\u9a6c\u9521":w,"xn--bck1b9a5dre4c":w,"\u30d5\u30a1\u30c3\u30b7\u30e7\u30f3":w,
...
function da(c,e,d){if(!1===e.allowPrivateDomains&&3<c.length){var f=c.length-1;e=c.charCodeAt(f);var k=c.charCodeAt(f-1),g=c.charCodeAt(f-2);c=c.charCodeAt(f-3);if(109===e&&111===k&&99===g&&46===c)return d.isIcann=!0,d.isPrivate=!1,d.publicSuffix="com",!0;if(103===e&&114===k&&111===g&&46===c)return d.isIcann=!0,d.isPrivate=!1,d.publicSuffix="org",!0;if(117===e&&100===k&&101===g&&46===c)return d.isIcann=!0,d.isPrivate=!1,d.publicSuffix="edu",!0;if(118===e&&111===k&&103===g&&46===c)return d.isIcann=
!0,d.isPrivate=!1,d.publicSuffix="gov",!0;if(116===e&&101===k&&110===g&&46===c)return d.isIcann=!0,d.isPrivate=!1,d.publicSuffix="net",!0;if(101===e&&100===k&&46===g)return d.isIcann=!0,d.isPrivate=!1,d.publicSuffix="de",!0}return !1}function ea(c,e,d,f){for(var k=null;void 0!==e;){0!==(e.$&f)&&(k={index:d+1,isIcann:1===e.$,isPrivate:2===e.$});if(-1===d)break;e=(e=e.succ)&&(e[c[d]]||e["*"]);--d;}return k}
function Z(c,e,d){if(!0!==da(c,e,d)){c=c.split(".");e=(!0===e.allowPrivateDomains?2:0)|(!0===e.allowIcannDomains?1:0);var f=ea(c,q,c.length-1,e);null!==f?(d.isIcann=f.isIcann,d.isPrivate=f.isPrivate,d.publicSuffix=c.slice(f.index+1).join(".")):(e=ea(c,v,c.length-1,e),null!==e?(d.isIcann=e.isIcann,d.isPrivate=e.isPrivate,d.publicSuffix=c.slice(e.index).join(".")):(d.isIcann=!1,d.isPrivate=!1,d.publicSuffix=c[c.length-1]));}}var getDomain$1=function(c,e){return n(c,3,Z,e).domain};
var getHostname=function(c,e){return n(c,0,Z,e).hostname};var getPublicSuffix=function(c,e){return n(c,2,Z,e).publicSuffix};var getSubdomain$1=function(c,e){return n(c,4,Z,e).subdomain};var parse=function(c,e){return n(c,5,Z,e)};
